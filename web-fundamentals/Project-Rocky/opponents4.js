...
setTimeout(()=>{sliderLoad(powerSlider, 60)}, 500);
setTimeout(()=>{sliderLoad(staminaSlider, 80)}, 500);
setTimeout(()=>{sliderLoad(agilitySlider, 68)}, 500);
setTimeout(()=>{sliderLoad(chinSlider, 68)}, 500);
setTimeout(()=>{sliderLoad(strategySlider, 72)}, 500);
setTimeout(()=>{sliderLoad(intimidationSlider, 68)}, 500);