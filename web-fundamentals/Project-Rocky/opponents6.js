...
function nextPage() {
    location.href = "opponents5.html"
}
function previousPage() {
    location.href = "opponents7.html"
}
...
setTimeout(()=>{sliderLoad(powerSlider, 85)}, 500);
setTimeout(()=>{sliderLoad(staminaSlider, 15)}, 500);
setTimeout(()=>{sliderLoad(agilitySlider, 55)}, 500);
setTimeout(()=>{sliderLoad(chinSlider, 40)}, 500);
setTimeout(()=>{sliderLoad(strategySlider, 12)}, 500);
setTimeout(()=>{sliderLoad(intimidationSlider, 88)}, 500);