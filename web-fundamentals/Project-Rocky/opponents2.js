...
setTimeout(()=>{sliderLoad(agilitySlider, 30)}, 500);
setTimeout(()=>{sliderLoad(chinSlider, 85)}, 500);
setTimeout(()=>{sliderLoad(strategySlider, 35)}, 500);
setTimeout(()=>{sliderLoad(intimidationSlider, 94)}, 500);