...
function nextPage() {
    location.href = "opponents4.html"
}
function previousPage() {
    location.href = "opponents6.html"
}
...
setTimeout(()=>{sliderLoad(powerSlider, 80)}, 500);
setTimeout(()=>{sliderLoad(staminaSlider, 68)}, 500);
setTimeout(()=>{sliderLoad(agilitySlider, 40)}, 500);
setTimeout(()=>{sliderLoad(chinSlider, 68)}, 500);
setTimeout(()=>{sliderLoad(strategySlider, 85)}, 500);
setTimeout(()=>{sliderLoad(intimidationSlider, 70)}, 500);