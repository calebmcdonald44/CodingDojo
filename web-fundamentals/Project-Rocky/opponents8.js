...
setTimeout(()=>{sliderLoad(staminaSlider, 40)}, 500);
setTimeout(()=>{sliderLoad(agilitySlider, 45)}, 500);
setTimeout(()=>{sliderLoad(chinSlider, 25)}, 500);
setTimeout(()=>{sliderLoad(strategySlider, 15)}, 500);
setTimeout(()=>{sliderLoad(intimidationSlider, 40)}, 500);