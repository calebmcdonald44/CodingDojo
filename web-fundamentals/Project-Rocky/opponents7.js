...
setTimeout(()=>{sliderLoad(powerSlider, 40)}, 500);
setTimeout(()=>{sliderLoad(staminaSlider, 70)}, 500);
setTimeout(()=>{sliderLoad(agilitySlider, 65)}, 500);
setTimeout(()=>{sliderLoad(chinSlider, 40)}, 500);
setTimeout(()=>{sliderLoad(strategySlider, 70)}, 500);
setTimeout(()=>{sliderLoad(intimidationSlider, 20)}, 500);